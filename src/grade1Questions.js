...
export const grade1Questions = [
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "A surprise — something different each day", visual: 'face-happy' },
      { letter: 'C', text: "A problem — something is wrong", visual: 'warning' }
    ],
    correctAnswer: "A",
    strand: "Computational Thinking"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Jump → Say 'Goodbye!'", visual: 'x-wrong' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Favorite color, favorite animal, favorite food", visual: 'school-book' },
      { letter: 'B', text: "Hobbies, likes, dislikes", visual: 'face-happy' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Space bar", visual: 'key-spacebar' },
      { letter: 'B', text: "Shift key", visual: 'key-shift' },
      { letter: 'C', text: "Backspace", visual: 'key-backspace' }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
