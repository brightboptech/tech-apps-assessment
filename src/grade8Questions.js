...
export const grade8Questions = [
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Build the whole site at once with no plan" },
      { letter: 'B', text: "List all features, group them by page, and make a checklist for each page" },
      { letter: 'C', text: "Only build the homepage and skip the rest" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "It lets you skip the planning step" },
      { letter: 'D', text: "It cuts down the total number of tasks" }
    ],
    correctAnswer: "B",
    strand: "Computational Thinking"
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: "Use a different language for each screen" }
    ],
    correctAnswer: "B",
    strand: "Computational Thinking"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Ignore it — it might be a coincidence" },
      { letter: 'B', text: "Build a feature that warns teachers on Thursdays when Friday scores are likely to drop" },
      { letter: 'C', text: "Delete all Friday data to fix the problem" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Patterns only work in math, not programming" },
      { letter: 'D', text: "Using patterns always slows a program down" }
    ],
    correctAnswer: "B",
    strand: "Computational Thinking"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Delete the algorithm and start over" },
      ...
      { letter: 'D', text: "Switch to a totally different programming language" }
    ],
    correctAnswer: "B",
    strand: "Computational Thinking"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Rewrite the whole program without looking at the error" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Integer, because logged-in users get a number ID" },
      { letter: 'B', text: "Boolean, because the user is either logged in (true) or not (false) — only two states exist" },
      { letter: 'C', text: "String, because the name 'isLoggedIn' has letters" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: "A single if-statement outside any loop" }
    ],
    correctAnswer: "B",
    strand: "Computational Thinking"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "A sequence that asks once and then stops" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Skip research and think of only one idea" },
      { letter: 'D', text: "Pick the first idea and present it with no testing" }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Designing the app in English only" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Repeat the same design with no changes" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Only big tech companies benefit, not workers" },
      { letter: 'D', text: "Gig apps have had no effect on jobs" }
    ],
    correctAnswer: "B",
    strand: "Creativity and Innovation"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Screenshot a weather website once a week" },
      ...
      { letter: 'D', text: "Use only printed weather reports from the library" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Manual data entry — typing each response by hand" },
      { letter: 'B', text: "Automated digital collection — using connected tools to gather and organize data with little manual work" },
      { letter: 'C', text: "Informal collection — gathering opinions with no structure" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Combine name and ID into one column to have fewer columns" },
      { letter: 'D', text: "Put each student's info in a separate spreadsheet file" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      { letter: 'A', text: "It makes the spreadsheet harder to read by adding color" },
      { letter: 'B', text: "It adds a visual layer that lets users quickly spot patterns and outliers without reading every cell" },
      { letter: 'C', text: "Conditional formatting changes the actual data values" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Data validation only matters for financial data" },
      { letter: 'D', text: "Naming rules have no real effect on data analysis" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Keep only one copy on one person's computer" },
      { letter: 'D', text: "Delete old versions to save storage" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Delete all entries with the wrong format" },
      { letter: 'D', text: "Make a separate chart for each format" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "As many colors and fonts as possible" },
      { letter: 'D', text: "Only raw numbers with no context" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "The raw dataset with no explanation" },
      { letter: 'B', text: "Clear citations for all sources, a description of the methods used, and a note about the study's limits" },
      { letter: 'C', text: "Personal opinions made to look like data-backed conclusions" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Fill each slide with as much text as possible" },
      ...
      { letter: 'D', text: "Read every word on each slide aloud" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Never posting anything online" },
      ...
      { letter: 'D', text: "Posting as often as possible to build the biggest presence" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Only looking at her last week of social media posts" },
      ...
      { letter: 'D', text: "Only asking close friends if her online presence looks OK" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Email is informal, so no etiquette rules apply" },
      { letter: 'D', text: "She should have sent a text instead" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Yes — under 30 seconds is always fair use" },
      ...
      { letter: 'C', text: "Yes — school projects always count as fair use" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Pay a fee to the creator before each use" },
      { letter: 'D', text: "Get written permission from the creator for every project" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Fair use, because she changed some words" },
      ...
      { letter: 'C', text: "Legal use, because all internet content is public domain" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "A routine IT notice — click the link and enter the password" },
      ...
      { letter: 'D', text: "A virus — she should restart her device" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Public Wi-Fi is only slower, with no other risk" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "It's fine as long as she doesn't use bad language" },
      { letter: 'D', text: "It's only a problem if the replies are public" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "A printed spreadsheet passed around one at a time" },
      ...
      { letter: 'D', text: "A PowerPoint file with embedded tables" }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "A presentation app like Google Slides" },
      { letter: 'D', text: "A word processing app like Microsoft Word" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Single-app processing — doing everything in one tool" },
      { letter: 'B', text: "Data integration — moving and using data across multiple connected apps in one workflow" },
      { letter: 'C', text: "Data deletion — removing data from each app after use" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "The school website is permanently down" },
      ...
      { letter: 'C', text: "The laptop needs a full OS reinstall" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "To create and manage user accounts only" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "It speeds up the internet by routing traffic faster" },
      ...
      { letter: 'C', text: "It lets her bypass content filters to reach blocked sites" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Save all files on the desktop for fast access" },
      ...
      { letter: 'D', text: "Keep all files in one folder to avoid confusion" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: "Ignore the warning and keep working" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Print the document, scan it, and retype it" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Voice dictation has replaced the need for typing" },
      { letter: 'D', text: "Touchscreens have replaced physical keyboards" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Users need to see every building" },
      { letter: 'C', text: "It removes clutter so users can focus on navigation — the essential information" },
      { letter: 'D', text: "Abstraction always removes too much detail" }
    ],
    correctAnswer: "C",
    strand: "Computational Thinking"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "It doesn't help with updates" },
      ...
      { letter: 'D', text: "You must rewrite the loop every time you update" }
    ],
    correctAnswer: "B",
    strand: "Computational Thinking"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "She is wasting time" },
      { letter: 'D', text: "Three failures means the idea is bad" }
    ],
    correctAnswer: "B",
    strand: "Creativity and Innovation"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Rocket science and software have nothing in common" },
      { letter: 'B', text: "Both use the same iterative design cycle: plan, build, test, learn from failures, and improve" },
      { letter: 'C', text: "Only rockets use a design process" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Only the building step is shared" },
      { letter: 'D', text: "Industries never use similar processes" }
    ],
    correctAnswer: "B",
    strand: "Creativity and Innovation"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Privacy laws have no effect on technology" },
      { letter: 'D', text: "Data collection will remain unchanged" }
    ],
    correctAnswer: "B",
    strand: "Creativity and Innovation"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Only the name 'Python' transfers" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Integers can only be TRUE or FALSE" },
      { letter: 'D', text: "Boolean holds decimal numbers" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Text and numbers are the same data type" },
      { letter: 'D', text: "It makes no difference which type you use" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "All energy sources worldwide" },
      { letter: 'D', text: "Only oil-related results" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Search in a different language" },
      { letter: 'D', text: "Only search for images" }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: "Blogs don't need proper grammar" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Only her perspective matters" },
      ...
      { letter: 'C', text: "Delete other contributors' work" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Never use the internet" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Help them share it faster" },
      ...
      { letter: 'D', text: "Share it yourself first" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "They are all the same thing" },
      ...
      { letter: 'D', text: "Patents protect songs and books" }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Using one format for everything is better" },
      ...
      { letter: 'C', text: "File formats don't matter" },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Slideshows can't display images" },
      { letter: 'D', text: "Only spreadsheets can show charts" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Vector images are always smaller files" },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "None — these aren't technology terms" },
      ...
      { letter: 'D', text: "She should have avoided all technical language" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      { letter: 'A', text: "No strategy — she's just making folders" },
      ...
      { letter: 'D', text: "Deleting old files regularly" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Nothing — hard drive failures are unavoidable and unrecoverable" },
      ...
      { letter: 'D', text: "Only saved files she didn't care about" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Local storage is always better than cloud" },
      { letter: 'D', text: "USB drives don't store files" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Cloud storage is always free with unlimited space" },
      { letter: 'D', text: "Cloud storage is faster than local storage in all situations" }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      { letter: 'A', text: "It changes the actual grade values" },
      { letter: 'B', text: "It adds a visual layer that instantly flags important data without requiring manual review of every cell" },
      { letter: 'C', text: "Conditional formatting is only for professional accountants" },
