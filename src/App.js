...
function Dashboard({ profile, onLogout }) {
  ...
  const steps = [
    ...
    {
      num: 3, Icon: Layers,
      title: 'K–2 Teacher Script Mode',
      desc: 'Project questions on a smartboard and read aloud for Kindergarten, 1st, and 2nd grade.',
      body: 'Teaching Kindergarten, 1st, or 2nd grade? Use the Teacher Script button on your class pass page to project questions on a smartboard. Read each question and answer choice aloud while students follow along as a group.',
