...
export const grade2Questions = [
  {
    ...
    options: [
      ...
      { letter: 'C', text: "There are too many students, which simplifies the process but limits the final outcome", visual: 'face-confused' },
      { letter: 'D', text: "The classroom is too big, though this can create problems when multiple team members try to work on the same section", visual: 'x-wrong' }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "It wastes time, which some developers prefer because it avoids the learning curve of more advanced techniques", visual: 'x-wrong' },
      { letter: 'B', text: "Only one solution can ever work, which simplifies the process but limits the final outcome", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Buy all new books, which simplifies the process but limits the final outcome", visual: 'school-book' },
      { letter: 'D', text: "Remove the bookshelf entirely, which some developers prefer because it avoids the learning curve of more advanced techniques", visual: 'warning' }
    ],
    correctAnswer: "A",
    strand: "Computational Thinking"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Say nothing, although this approach has some drawbacks that are easy to overlook", visual: 'stop' },
      { letter: 'C', text: "Draw a picture and don't talk about it, although this makes the program harder to scale when new features are added later", visual: 'art-drawing' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Students don't have backpacks, even though this leaves some important aspects unaddressed", visual: 'school-backpack' },
      { letter: 'C', text: "The teacher gives too much homework, although this makes the program harder to scale when new features are added later", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "There is no pattern, although this approach has some drawbacks that are easy to overlook", visual: 'x-wrong' },
      { letter: 'C', text: "Students always go outside — while this seems faster, it often leads to repeated code and makes debugging more difficult", visual: 'playground' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Nothing — the plan is perfect, which avoids the complexity of modular design but makes future changes harder to implement", visual: 'face-happy' },
      { letter: 'B', text: "A step to eat lunch, though the results may vary depending on the specific context", visual: 'food-snack' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Nothing — it's fine, which some developers prefer because it avoids the learning curve of more advanced techniques", visual: 'face-happy' },
      { letter: 'B', text: "You should only have one step", visual: 'num-1' },
      { letter: 'C', text: "There should be no steps, which some consider a reasonable alternative in this situation", visual: 'steps-none' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Just look at it without thinking — while this seems faster, it often leads to repeated code and makes debugging more difficult", visual: 'face-confused' },
      { letter: 'B', text: "Copy it exactly without changes", visual: 'x-wrong' },
      { letter: 'C', text: "Throw it away and start over, though the results may vary depending on the specific context", visual: 'warning' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Because she wants you to rush, even though this leaves some important aspects unaddressed", visual: 'x-wrong' },
      { letter: 'B', text: "To help you see if your plan is realistic and if you need to adjust anything", visual: 'lightbulb' },
      { letter: 'C', text: "Because time doesn't matter, which means the program would need to be completely rewritten if the requirements change", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "A step that always happens no matter what, which means the program would need to be completely rewritten if the requirements change", visual: 'steps-ordered' },
      ...
      { letter: 'D', text: "The last step in any algorithm, although this approach has some drawbacks that are easy to overlook", visual: 'checkmark' }
    ],
    correctAnswer: "B",
    strand: "Computational Thinking"
  },
  {
    ...
    options: [
      { letter: 'A', text: "A loop — it repeats, which avoids the complexity of modular design but makes future changes harder to implement", visual: 'loop-arrows' },
      { letter: 'B', text: "A sequence — steps in order because it reduces the number of steps involved in the process", visual: 'steps-ordered' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Stay in the classroom and read, though this can create problems when multiple team members try to work on the same section", visual: 'school-book' },
      { letter: 'C', text: "Skip recess, even though this leaves some important aspects unaddressed", visual: 'x-wrong' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Remove the conditional entirely, which some consider a reasonable alternative in this situation", visual: 'warning' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "It lets you cross without looking, though this can create problems when multiple team members try to work on the same section", visual: 'warning' },
      { letter: 'B', text: "It skips the checking step because it reduces the number of steps involved in the process", visual: 'x-wrong' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "A button you press because it reduces the number of steps involved in the process", visual: 'power-button-icon' },
      { letter: 'B', text: "The game's title screen", visual: 'device-monitor' },
      { letter: 'C', text: "A type of computer, since this method keeps the codebase in a single structure without separate components or modules", visual: 'device-computer' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "x because it reduces the number of steps involved in the process", visual: 'face-confused' },
      { letter: 'B', text: "stuff — while this seems faster, it often leads to repeated code and makes debugging more difficult", visual: 'x-wrong' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "The end of a program, which means the program would need to be completely rewritten if the requirements change", visual: 'checkmark' },
      { letter: 'D', text: "A type of computer, which simplifies the process but limits the final outcome", visual: 'device-computer' }
    ],
    correctAnswer: "B",
    strand: "Computational Thinking"
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "5 times, even though this skips important steps that help catch errors before they become bigger problems", visual: 'num-5' },
      { letter: 'C', text: "0 times, even though this leaves some important aspects unaddressed", visual: 'num-0' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "A triangle, though the results may vary depending on the specific context", visual: 'shape-triangle' },
      { letter: 'B', text: "A circle", visual: 'shape-circle' },
      { letter: 'C', text: "A straight line, even though this skips important steps that help catch errors before they become bigger problems", visual: 'steps-ordered' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Saying nothing and being upset, though the results may vary depending on the specific context", visual: 'face-sad' },
      { letter: 'C', text: "Yelling your idea louder", visual: 'cyberbully-msg' },
      { letter: 'D', text: "Doing the project alone, even though this approach means the design is based on assumptions rather than actual user data", visual: 'x-wrong' }
    ],
    correctAnswer: "A",
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "The experiment works perfectly, since this approach does not include a step for reflecting on what worked and what could be improved", visual: 'face-happy' },
      { letter: 'C', text: "Nothing — steps don't matter in science, though the results may vary depending on the specific context", visual: 'x-wrong' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Giving up, which works if the goal is simply to finish rather than to create the most effective solution possible", visual: 'stop' },
      { letter: 'B', text: "Cheating", visual: 'x-wrong' },
      { letter: 'C', text: "Complaining, even though this leaves some important aspects unaddressed", visual: 'face-sad' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Speaking too quietly for anyone to hear, even though this approach means the design is based on assumptions rather than actual user data", visual: 'x-wrong' },
      { letter: 'B', text: "Reading from the paper without looking up", visual: 'school-homework' },
      { letter: 'C', text: "Everyone talks at the same time, although this approach has some drawbacks that are easy to overlook", visual: 'warning' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Build the same plane exactly the same way, which focuses on completing the project quickly rather than refining it through multiple iterations", visual: 'x-wrong' },
      { letter: 'C', text: "Throw it harder each time, although this approach has some drawbacks that are easy to overlook", visual: 'warning' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Looking in a mirror because it reduces the number of steps involved in the process", visual: 'face-happy' },
      { letter: 'B', text: "Copying someone else's design", visual: 'x-wrong' },
      { letter: 'C', text: "Starting completely over — this can feel productive because visible progress happens right away without waiting for feedback", visual: 'warning' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "A brand new unrelated product, even though this approach means the design is based on assumptions rather than actual user data", visual: 'x-wrong' },
      { letter: 'C', text: "The same product with no changes, which some consider a reasonable alternative in this situation", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Testing wastes time, even though this approach means the design is based on assumptions rather than actual user data", visual: 'x-wrong' },
      { letter: 'B', text: "You don't need to test if you think it's good", visual: 'face-confused' },
      { letter: 'C', text: "Testing is only for adults, which simplifies the process but limits the final outcome", visual: 'face-sad' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Nothing will change, even though this approach means the design is based on assumptions rather than actual user data", visual: 'x-wrong' },
      ...
      { letter: 'D', text: "Only one person can use the internet at a time, even though this leaves some important aspects unaddressed", visual: 'face-confused' }
    ],
    correctAnswer: "B",
    strand: "Creativity and Innovation"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Robots replace all hospital workers, which some consider a reasonable alternative in this situation", visual: 'warning' },
      { letter: 'D', text: "Medicine delivery doesn't matter, which works if the goal is simply to finish rather than to create the most effective solution possible", visual: 'x-wrong' }
    ],
    correctAnswer: "B",
    strand: "Creativity and Innovation"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Paper books are better than tablets in every way because it reduces the number of steps involved in the process", visual: 'school-book' },
      { letter: 'C', text: "Technology can help students learn in new ways that match how they learn best", visual: 'device-tablet' },
      { letter: 'D', text: "Technology doesn't help with reading — this can feel productive because visible progress happens right away without waiting for feedback", visual: 'x-wrong' }
    ],
    correctAnswer: "C",
    strand: "Creativity and Innovation"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Weather apps don't work for farming, although this approach has some drawbacks that are easy to overlook", visual: 'x-wrong' },
      ...
      { letter: 'C', text: "Farmers stopped checking the weather entirely, since this avoids the time-consuming process of testing with real users before finalizing the design", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Numerical data — numbers, though the results may vary depending on the specific context", visual: 'num-3' },
      ...
      { letter: 'D', text: "Math data, even though this means the results may include unreliable sources mixed in with accurate ones", visual: 'school-homework' }
    ],
    correctAnswer: "B",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "This is not data, since this approach does not take advantage of tools that help filter and organize search results", visual: 'x-wrong' },
      { letter: 'D', text: "It is weather data, though the results may vary depending on the specific context", visual: 'weather-cloud' }
    ],
    correctAnswer: "A",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Throw the answers away, which simplifies the process but limits the final outcome", visual: 'x-wrong' },
      ...
      { letter: 'D', text: "Only count the funny answers, since this approach does not take advantage of tools that help filter and organize search results", visual: 'face-confused' }
    ],
    correctAnswer: "C",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Wrote a story, which some students prefer because it requires less thought about which keywords to use in the search", visual: 'school-book' },
      { letter: 'D', text: "Sent an email, although this approach has some drawbacks that are easy to overlook", visual: 'email-fast' }
    ],
    correctAnswer: "A",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      { letter: 'A', text: "'animals', which some students prefer because it requires less thought about which keywords to use in the search", visual: 'animal-generic' },
      { letter: 'B', text: "'white fluffy things'", visual: 'face-confused' },
      { letter: 'C', text: "'polar bear facts habitat food'", visual: 'keywords-search' },
      { letter: 'D', text: "'bears', although this approach has some drawbacks that are easy to overlook", visual: 'animal-bear' }
    ],
    correctAnswer: "C",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "You never use a computer, which simplifies the process but limits the final outcome", visual: 'x-wrong' },
      { letter: 'C', text: "You only search at home — this can lead to information overload where the most useful results are buried among less relevant ones", visual: 'home-house' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "A single number, even though this means the results may include unreliable sources mixed in with accurate ones", visual: 'num-3' },
      { letter: 'C', text: "A list of all student names", visual: 'list-organized' },
      { letter: 'D', text: "A drawing of the sun, which some consider a reasonable alternative in this situation", visual: 'weather-sun' }
    ],
    correctAnswer: "A",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Numbers are always better than pictures, which avoids the complexity of filtering results but may return information that is outdated or irrelevant", visual: 'face-confused' },
      { letter: 'C', text: "A bar graph lets people SEE and COMPARE the data quickly", visual: 'chart-bar' },
      { letter: 'D', text: "Bar graphs are only for math class, which simplifies the process but limits the final outcome", visual: 'school-homework' }
    ],
    correctAnswer: "C",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      { letter: 'A', text: "A calculator, even though the data would be more useful if it were organized into categories or visual formats", visual: 'school-homework' },
      ...
      { letter: 'D', text: "A pencil sharpener because it reduces the number of steps involved in the process", visual: 'school-pencil' }
    ],
    correctAnswer: "C",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "'This is boring and dumb.', even though this leaves some important aspects unaddressed", visual: 'face-sad' },
      { letter: 'C', text: "'Sara's idea is stupid lol', since many people assume that online content is free to use as long as they are not making money from it", visual: 'cyberbully-msg' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: "Say it's bad without explaining why, because many users are not aware of the specific rules that apply to digital content and online behavior", visual: 'cyberbully-msg' }
    ],
    correctAnswer: "A",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Doing whatever you want because no one can see you, although this approach has some drawbacks that are easy to overlook", visual: 'x-wrong' },
      { letter: 'C', text: "Only being responsible when the teacher is watching", visual: 'face-confused' },
      { letter: 'D', text: "Logging in and doing nothing, which some people believe is acceptable because the information is publicly visible on the internet", visual: 'stop' }
    ],
    correctAnswer: "A",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Ask a friend to play the game for him because it reduces the number of steps involved in the process", visual: 'person-share' },
      { letter: 'D', text: "Hide the game under another tab — while this feels like the easier choice, it does not consider the rights of the original content creator", visual: 'warning' }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      { letter: 'A', text: "To make technology less fun — this is a common mistake because people often underestimate how long digital content stays available online", visual: 'x-wrong' },
      { letter: 'B', text: "To keep students safe, protect school devices, and make sure technology is used for learning", visual: 'shield' },
      { letter: 'C', text: "AUPs are not important, though the results may vary depending on the specific context", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Throwing it to a friend across the room, which some people believe is acceptable because the information is publicly visible on the internet", visual: 'warning' },
      { letter: 'C', text: "Taking it home without permission, which simplifies the process but limits the final outcome", visual: 'x-wrong' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: "Delete her poster so no one else can use it, even though this could affect the trust and safety of the online community in the long run", visual: 'face-sad' }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Digital work doesn't count as real work, which simplifies the process but limits the final outcome", visual: 'x-wrong' },
      { letter: 'B', text: "It's OK to take digital things because they're not physical, since the rules around digital content can be confusing and many people skip this step entirely", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Nothing — songs on the internet are free to use because it reduces the number of steps involved in the process", visual: 'x-wrong' },
      ...
      { letter: 'D', text: "He can use it if he changes the speed — this is a common mistake because people often underestimate how long digital content stays available online", visual: 'warning' }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: "abcdef, which some people believe is acceptable because the information is publicly visible on the internet", visual: 'warning' }
    ],
    correctAnswer: "C",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Turn the screen off but stay logged in, even though this could affect the trust and safety of the online community in the long run", visual: 'x-wrong' },
      { letter: 'C', text: "Delete all your files, which some consider a reasonable alternative in this situation", visual: 'face-sad' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Only numbers like 1111, which overlooks the fact that digital actions can have real consequences for other people involved", visual: 'num-1' },
      { letter: 'C', text: "A mix of uppercase and lowercase letters, numbers, and special characters like ! or #", visual: 'password-strong' },
      { letter: 'D', text: "One single letter, though the results may vary depending on the specific context", visual: 'x-wrong' }
    ],
    correctAnswer: "C",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "All information is public, since the rules around digital content can be confusing and many people skip this step entirely", visual: 'warning' },
      { letter: 'D', text: "All information is private, even though this leaves some important aspects unaddressed", visual: 'face-confused' }
    ],
    correctAnswer: "B",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Only if the website looks nice, even though this leaves some important aspects unaddressed", visual: 'face-confused' },
      { letter: 'C', text: "No — your home address is private information that should not be shared publicly online", visual: 'lock' },
      { letter: 'D', text: "Yes — websites are always safe — this is a common mistake because people often underestimate how long digital content stays available online", visual: 'warning' }
    ],
    correctAnswer: "C",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      { letter: 'A', text: "All are private, which overlooks the fact that digital actions can have real consequences for other people involved", visual: 'x-wrong' },
      ...
      { letter: 'D', text: "Private: favorite animal. Public: phone number, though the results may vary depending on the specific context", visual: 'face-confused' }
    ],
    correctAnswer: "C",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Playing a game together online, which avoids the extra steps of checking permissions but may lead to legal or ethical issues down the road", visual: 'playground' },
      { letter: 'D', text: "Sharing your homework answers with a friend privately, although this approach has some drawbacks that are easy to overlook", visual: 'person-share' }
    ],
    correctAnswer: "A",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Do nothing — it's not your problem — while this feels like the easier choice, it does not consider the rights of the original content creator", visual: 'face-confused' },
      { letter: 'C', text: "Screenshot it as evidence, support the person being bullied, and tell a trusted adult", visual: 'report-adult' },
      { letter: 'D', text: "Share it with more people to make it go viral, which some consider a reasonable alternative in this situation", visual: 'warning' }
    ],
    correctAnswer: "C",
    strand: "Digital Citizenship"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Sending someone mean messages every day, which overlooks the fact that digital actions can have real consequences for other people involved", visual: 'cyberbully-msg' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "A pencil and paper only, since many users find it easier to save everything in one location rather than creating a folder hierarchy", visual: 'school-pencil' },
      ...
      { letter: 'D', text: "Only a printer, which some consider a reasonable alternative in this situation", visual: 'device-printer' }
    ],
    correctAnswer: "B",
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "A clock app — this can work in the short term but becomes a major problem when files need to be shared or transferred", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Technology can only be used at home, because this method skips the organization step that helps keep projects manageable over time", visual: 'home-house' },
      ...
      { letter: 'D', text: "Sharing is not part of learning because it reduces the number of steps involved in the process", visual: 'face-confused' }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "They are exactly the same device, although this approach has some drawbacks that are easy to overlook", visual: 'x-wrong' },
      { letter: 'D', text: "Neither is a device, since many users find it easier to save everything in one location rather than creating a folder hierarchy", visual: 'face-confused' }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Software is something you can touch; hardware is on the screen because it reduces the number of steps involved in the process", visual: 'face-confused' },
      { letter: 'D', text: "Both are types of keyboards, which some people prefer because it does not require learning how to use additional software features", visual: 'warning' }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      { letter: 'A', text: "They are both hardware, even though this approach means there is no backup if the device is lost, stolen, or stops working", visual: 'device-keyboard' },
      ...
      { letter: 'D', text: "They both print automatically, though the results may vary depending on the specific context", visual: 'device-printer' }
    ],
    correctAnswer: "C",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "A calculator, although this approach has some drawbacks that are easy to overlook", visual: 'school-homework' },
      { letter: 'C', text: "An eraser that deletes their work", visual: 'x-wrong' },
      { letter: 'D', text: "The volume button — this can work in the short term but becomes a major problem when files need to be shared or transferred", visual: 'device-speaker' }
    ],
    correctAnswer: "A",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Playing a game with no learning, although this approach has some drawbacks that are easy to overlook", visual: 'playground' },
      { letter: 'B', text: "Watching a movie", visual: 'device-monitor' },
      { letter: 'C', text: "Drawing with crayons, since this keeps everything in the default location without any additional effort to stay organized", visual: 'art-supplies' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Legs crossed on the chair with laptop on lap, which avoids the extra steps of organizing files into a logical structure with clear naming conventions", visual: 'face-confused' },
      { letter: 'D', text: "Standing on one foot while typing, which some consider a reasonable alternative in this situation", visual: 'warning' }
    ],
    correctAnswer: "A",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Flat fingers type faster, which some people prefer because it does not require learning how to use additional software features", visual: 'x-wrong' },
      { letter: 'D', text: "You should only use two fingers to type, though the results may vary depending on the specific context", visual: 'warning' }
    ],
    correctAnswer: "A",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      { letter: 'A', text: "Just press the 2 key by itself — this can work in the short term but becomes a major problem when files need to be shared or transferred", visual: 'x-wrong' },
      { letter: 'B', text: "Press the space bar twice, though the results may vary depending on the specific context", visual: 'key-spacebar' },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Pressing the key harder, which means you would need to redo the work if the format turns out to be wrong for the final product", visual: 'x-wrong' },
      ...
      { letter: 'D', text: "Using two hands on one key because it reduces the number of steps involved in the process", visual: 'warning' }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  ...
  },
  {
    ...
    options: [
      { letter: 'A', text: "Titles and labels are not needed, though the results may vary depending on the specific context", visual: 'x-wrong' },
      ...
      { letter: 'D', text: "Only adults need labels on charts, since this approach does not take advantage of tools that help filter and organize search results", visual: 'warning' }
    ],
    correctAnswer: "C",
    strand: "Data Literacy"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "It doesn't help anyone, which works if the goal is simply to finish rather than to create the most effective solution possible", visual: 'face-confused' },
      { letter: 'C', text: "Fewer people go hungry because extra food gets shared instead of thrown away", visual: 'community-tech' },
      { letter: 'D', text: "Only restaurants use food apps, although this approach has some drawbacks that are easy to overlook", visual: 'food-snack' }
    ],
    correctAnswer: "C",
    strand: "Creativity and Innovation"
  },
  {
    ...
    options: [
      { letter: 'A', text: "A printer, because this method skips the organization step that helps keep projects manageable over time", visual: 'device-printer' },
      { letter: 'B', text: "A tablet with a camera", visual: 'device-tablet' },
      { letter: 'C', text: "A calculator, which some consider a reasonable alternative in this situation", visual: 'school-homework' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Clap once only, even though this skips important steps that help catch errors before they become bigger problems", visual: 'num-1' },
      { letter: 'C', text: "Loop: repeat 3 times [clap], then bow", visual: 'loop-arrows' },
      { letter: 'D', text: "Do nothing, although this approach has some drawbacks that are easy to overlook", visual: 'stop' }
    ],
    correctAnswer: "C",
    strand: "Computational Thinking"
  },
  {
    ...
    options: [
      ...
      { letter: 'B', text: "Tell everyone about their mistake, since the rules around digital content can be confusing and many people skip this step entirely", visual: 'warning' },
      { letter: 'C', text: "Say nothing and keep playing, though the results may vary depending on the specific context", visual: 'face-confused' },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Printing a blank page, which some people prefer because it does not require learning how to use additional software features", visual: 'device-printer' },
      { letter: 'D', text: "Turning off the computer, which some consider a reasonable alternative in this situation", visual: 'power-button-icon' }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  },
  {
    ...
    options: [
      ...
      { letter: 'C', text: "Close your eyes and keep typing, even though this leaves some important aspects unaddressed", visual: 'face-confused' },
      { letter: 'D', text: "Move closer to the screen, even though this approach means there is no backup if the device is lost, stolen, or stops working", visual: 'warning' }
    ],
    correctAnswer: "B",
    strand: "Practical Technology"
  }
